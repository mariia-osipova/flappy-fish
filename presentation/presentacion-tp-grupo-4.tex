...
\begin{frame}
\frametitle{Resumen de la presentacion (I)}

\tableofcontents[sections={1-3}]
\end{frame}

\begin{frame}
\frametitle{Resumen de la presentacion (II)}
...
%            \includegraphics[width=\textwidth]{death2.png}
%        \end{column}
%        \begin{column}{0.5\textwidth}
...
\begin{columns}[T]
    \begin{column}{0.35\textwidth}
        ...
        donde cada uno aprende a jugar debido las generaciones pasadas.
    \end{column}
