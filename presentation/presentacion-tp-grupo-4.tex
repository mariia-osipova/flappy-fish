...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \textbf{screamer.py} — módulo del screamer para el juego en modo manual.
        ...
        \item \textbf{swim\_fish.py} — lógica del juego (modo manual) y modo con Algoritmo Genético.
...
Entonces, el Game sabe todo sobre la ventana, el fondo y las tuberías,
...
%------------------------------------------------
\begin{frame}[fragile]
\frametitle{Módulo fish.py: el Fish y su fisica (I)}
...
\begin{frame}[fragile]
\frametitle{Módulo fish.py: el Fish y su fisica (II)}
...
\begin{frame}[fragile]
\frametitle{Módulo fish.py: el Fish y su fisica (III)}
...
\begin{frame}[fragile]
\frametitle{Módulo fish.py (V)}

\begin{itemize}
    \item El método \texttt{reset()} restablece el pez a su posición inicial, reinicia su velocidad y reconstruye el \texttt{rect} y la máscara originales. Se usa en el caso de una colicion para reiniciar el juego.
\end{itemize}
