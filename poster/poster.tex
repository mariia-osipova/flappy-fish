...
\author{%
  \vspace{5pt}
  {\usebeamerfont{author} Pensamiento computacional (I100)}\\
  \vspace{11pt}
...
\footercontent{%
  ...
  \end{minipage}%
  \hfill
  % центр: 3 рыбки без подбора ширин под каждую
  \begin{minipage}[c]{0.60\textwidth}
    \centering
    \includegraphics[height=0.6\footerbgheight]{logos/fish-big.png}\hspace{6pt}%
    \includegraphics[height=0.6\footerbgheight]{logos/fish-big.png}\hspace{6pt}%
    \includegraphics[height=0.6\footerbgheight]{logos/fish-big.png}\hspace{6pt}%
    \includegraphics[height=0.6\footerbgheight]{logos/fish-big.png}\hspace{6pt}%
    \includegraphics[height=0.6\footerbgheight]{logos/fish-big.png}\hspace{6pt}%
    \includegraphics[height=0.6\footerbgheight]{logos/fish-big.png}%
  \end{minipage}%
  \hfill
  % правая колонка
...
\begin{column}{\colwidth}
  ...
  \begin{alertblock}{Objetivos}
    ...
    \begin{itemize}
      ...
      modular capaz de integrar dos modos de juego distintos (Manual y Simulado). El objetivo es demostrar la separación
      ...
      \vspace{17pt}
      \item \textbf{Optimizar el Comportamiento de Agentes mediante Aprendizaje Automático:}Capacitar a una población de agentes mediante mecanismos de evolución simulada (selección, cruce y mutación).
      \vspace{17pt}
  ...
  \begin{block}{Metodología y Dualidad Operativa}
    ...
    permitiendo la integración fluida de ambos modos dentro de un marco unificado.
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Arquitectura general del juego}
    ...
    \begin{figure}
      ...
      \small Figura 5: Flowchart de la arquitectura del proyecto
    \end{figure}
